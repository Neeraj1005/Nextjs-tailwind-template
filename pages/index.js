...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* navbar goes here */}
      <div className="py-16">
        <nav className="bg-gray-400 fixed top-0 inset-x-0">
        ...
        {/* content goes here */}
        <div className="py-32 bg-red-600 text-center">
          <h2 className="font-extrabold text-4xl">Navbars in Tailwind</h2>
        </div>
        <div className="py-32 bg-green-400 text-center">
          <h2 className="font-extrabold text-4xl">Navbars in Tailwind</h2>
        </div>
        <div className="py-32 bg-blue-200 text-center">
          <h2 className="font-extrabold text-4xl">Navbars in Tailwind</h2>
        </div>
        <div className="py-32 bg-yellow-300 text-center">
          <h2 className="font-extrabold text-4xl">Navbars in Tailwind</h2>
        </div>
        <div className="py-32 bg-red-300 text-center">
          <h2 className="font-extrabold text-4xl">Navbars in Tailwind</h2>
        </div>
        <div className="py-32 bg-pink-200 text-center">
          <h2 className="font-extrabold text-4xl">Navbars in Tailwind</h2>
        </div>
      </div>
    </>
